...
% CONTACT INFORMATION
%====================
\def\name{Pratik Gupta} % Name Here
\def\phone{(+91) 8001284875}
\def\city{Kolkata, West Bengal, IN}
\def\email{pratikguptamain@gmail.com}
\def\LinkedIn{thepratikguptaa} % linkedin.com/in/______
\def\github{thepratikgupta} % github username
